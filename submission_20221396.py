...
class submission_20221396(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True):
        ...
        #filters = [64, 128, 256, 512, 1024] #26,974,658
        #filters = [32, 64, 128, 256, 512] #6,750,434
        #filters = [16, 32, 64, 128, 256] #1,690,994 -> 649,741
        filters = [8, 16, 32, 64, 128] #424,442 -> 165,461
